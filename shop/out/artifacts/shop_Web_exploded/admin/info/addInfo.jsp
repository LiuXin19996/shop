...
<HTML>
	...
	<body>
		<form id=" " name="Form1" action="${pageContext.request.contextPath}/adminInfo_saveInfo.action?adminName=<s:property value="#session.existAdminUser.username"/>&page=1" method="post">
			&nbsp;
