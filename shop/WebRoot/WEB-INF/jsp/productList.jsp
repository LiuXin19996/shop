...
<div class="container productList">
	...
	<div class="pagination">
		...
		<s:elseif test=" proname !='123'.toString() ">
			<s:if test="pageBean.page != 1">
				<a href="${ pageContext.request.contextPath }/product_findByPname.action?proname=<s:property value="proname"/>&page=1" class="firstPage">&nbsp;</a>
				<a href="${ pageContext.request.contextPath }/product_findByPname.action?proname=<s:property value="proname"/>&page=<s:property value="pageBean.page-1"/>" class="previousPage">&nbsp;</a>
			</s:if>
			
			<s:iterator var="i" begin="1" end="pageBean.totalPage">
				<s:if test="pageBean.page != #i">
					<a href="${ pageContext.request.contextPath }/product_findByPname.action?proname=<s:property value="proname"/>&page=<s:property value="#i"/>"><s:property value="#i"/></a>
				</s:if>
				<s:else>
					<span class="currentPage"><s:property value="#i"/></span>
				</s:else>
			...
			<s:if test="pageBean.page != pageBean.totalPage">	
				<a class="nextPage" href="${ pageContext.request.contextPath }/product_findByPname.action?proname=<s:property value="proname"/>&page=<s:property value="pageBean.page+1"/>">&nbsp;</a>
				<a class="lastPage" href="${ pageContext.request.contextPath }/product_findByPname.action?proname=<s:property value="proname"/>&page=<s:property value="pageBean.totalPage"/>">&nbsp;</a>
			</s:if>
		</s:elseif>	
